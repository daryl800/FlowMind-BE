...
def calc_bazi(dt: datetime, tz_name="Asia/Hong_Kong", longitude: float = 114.17):
    ...
    # 3️⃣ 子初换日（基于真太阳时判断）
    # 注意：此逻辑是基于“23点后即换日”的规则（部分流派）。
    # 如果您的规则是“晚子时（23-0点）用次日日柱”，则需要更精细的逻辑。
...
# ... [之前的所有函数定义保持不变，包括 calculate_true_solar_time, calc_bazi, localize_pillars 等] ...
...
def run_comprehensive_tests():
    ...
    test_cases = [
        # 案例 1: 1966-10-09 07:00 香港 (基础验证)
        {
            ...
            "tz": "Asia/Hong_Kong",
            "lon": 114.17,
            "expected_bazi_cn": "丙午 戊戌 辛丑 辛卯" # 经真太阳时校正后应为辛卯时
        },
